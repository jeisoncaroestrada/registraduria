...
class SignupForm extends Request {
	...
	public function messages()
    {
        return [
            ...
            'check2.required' => 'Por favor dar click en "Acepto recibir vía e-mail información relevante de yoDecido.net"',
            'check1.required' => 'Por favor dar click en "Acepto Términos y condiciones de Dialectus.co"'
        ];
    }
