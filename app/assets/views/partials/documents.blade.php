	...
	<section class="wid-100 start-container bg-gray">
		<article class="col-md-7 padding-t-b-50-auto" data-sr="enter left please, and hustle 100px over 1s no reset">
			<div class="page-header">
			  <h1 class="header-title-custom shadow-gray">Proyectos, Documentación, Material de consulta</h1>
			</div>
			<div class="col-md-12 fs-20 fc-W">
				<p>Es un conjunto de información que trabaja
					como repositorio de material de consulta,
					proyectos, estudios de referencia, bibliografía
					y otros documentos que al ser consultados
					y analizados permiten tomar decisiones
					sobre las consultas, encuestas y
					debates del movimiento innovador. Permite
					conocer las últimas noticias, hacer seguimiento
					a los indicadores del plan estratégico
					del movimiento y descargar los informes
